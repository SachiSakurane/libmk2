...
#define MK2_IPP_FIXED_ACCURACY_ARITHMETIC_ASSOCIATOR_FLOAT_FLOAT_COMPLEX(base_struct, base_func, name, desc)            \
    MK2_PP_REPLACE_TO_TEMPLATE_FUNC(base_struct, base_func(_32fc_A11, name, desc), (Ipp32f, Ipp32fc, precision_low))    \
    MK2_PP_REPLACE_TO_TEMPLATE_FUNC(base_struct, base_func(_32fc_A21, name, desc), (Ipp32f, Ipp32fc, precision_mid))    \
    MK2_PP_REPLACE_TO_TEMPLATE_FUNC(base_struct, base_func(_32fc_A24, name, desc), (Ipp32f, Ipp32fc, precision_high))   \
    MK2_PP_REPLACE_TO_TEMPLATE_FUNC(base_struct, base_func(_64fc_A26, name, desc), (Ipp64f, Ipp64fc, precision_low))    \
    MK2_PP_REPLACE_TO_TEMPLATE_FUNC(base_struct, base_func(_64fc_A50, name, desc), (Ipp64f, Ipp64fc, precision_mid))    \
    MK2_PP_REPLACE_TO_TEMPLATE_FUNC(base_struct, base_func(_64fc_A53, name, desc), (Ipp64f, Ipp64fc, precision_high))
...
#define MK2_IPP_FAA_BINARY_ARGS (psrc1, psrc2, pdst, len)
    ...
    // root
    // sqrt
    MK2_IPP_REPLACE_TEMPLATE(sqrt, ippsSqrt, , MK2_IPP_FAA_UNARY_SIGNATURE, MK2_IPP_FAA_UNARY_ARGS, (Type, PrecisionType), MK2_IPP_FIXED_ACCURACY_ARITHMETIC_ASSOCIATOR)
    ...
    // exponential
    // exp
    MK2_IPP_REPLACE_TEMPLATE(exp, ippsExp, , MK2_IPP_FAA_UNARY_SIGNATURE, MK2_IPP_FAA_UNARY_ARGS, MK2_IPP_FIXED_ACCURACY_ARITHMETIC_ASSOCIATOR)
    
    // expm1
    MK2_IPP_REPLACE_TEMPLATE(expm1, ippsExpm1, , MK2_IPP_FAA_UNARY_SIGNATURE, MK2_IPP_FAA_UNARY_ARGS, MK2_IPP_FIXED_ACCURACY_ARITHMETIC_ASSOCIATOR_FLOAT)
