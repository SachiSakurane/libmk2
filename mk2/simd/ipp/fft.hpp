...
namespace mk2 { namespace simd { namespace ipp {
    ...
    public:
        ...
        void process(const Type* src_re, const Type* src_im, Type* dst_re, Type* dst_im)
        {
            function::ipps_fft_fwd_ctoc(src_re, src_im, dst_re, dst_im, fft_spec_, pfft_work_buf_);
        }
    
        void process_inplace(Type* src_dst_re, Type* src_dst_im)
        {
            function::ipps_fft_fwd_ctoc_inplace(src_dst_re, src_dst_im, fft_spec_, pfft_work_buf_);
        }
